...
class AuthService:
    ...
    def register(self, username: str, email: str, password: str) -> User:
        """This function creates a new user. Raises AuthError if email already exists."""
    ...
    def login(self, email: str, password: str) -> str:
        """This function validates the credentials and returns a session token.
    ...
    def get_current_user(self, token: str) -> User:
        """This function resolves a session token to a User. Raises AuthError if invalid."""
